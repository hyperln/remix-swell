...
import { removeItemFromCart } from '~/lib/swell';
...
export default function Cart() {
    ...
    console.log(cart);
    // const imageUrl = cart?.items[0]?.product?.images[0]?.file?.url;
                                        ...
                                        <div className="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                                            ...
                                            <div className="mt-4 sm:mt-0 sm:pr-9">
                                                ...
                                                <div className="absolute top-0 right-0">
                                                    <button onClick={() => removeItemFromCart(item.id)} type="button" className="-m-2 inline-flex p-2 text-gray-400 hover:text-gray-500">
